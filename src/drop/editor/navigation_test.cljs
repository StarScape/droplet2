...
(def doc (core/document [para, (core/paragraph [(core/run "foo bar?")])]))

(deftest next-word-paragraph-test
  (testing "starting from word-char goes to end of that word"
    (is (= 5 (caret (next-word para (selection [-1 0]))))))
