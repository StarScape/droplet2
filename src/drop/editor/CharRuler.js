 ...
 *
 * I opted to keep this as a JS class, rather than rewrite it in Clojure, because it's
 * really an ideal fit for OO and hiding the "nasty bits" of the implementation.
 */
export class CharRuler {
